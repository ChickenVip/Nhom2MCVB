...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="panel panel-primary">
			...
			<h3 class="panel-title"></h3><center>THÊM MINH CHỨNG</center></h3>
			</div>
		</div>

		<br />
		<form  class="form-horizontal" action="adminadddoc" method="post"">
	    ...
	    <div class="form-group">
		    <label class="col-sm-2 ">Link file minh chứng:</label>
		    <div class="col-sm-10">
			<input type="text" class="form-control" name="content" placeholder="Nhập link file vào đây"/>		   
			</div>
	    </div>
