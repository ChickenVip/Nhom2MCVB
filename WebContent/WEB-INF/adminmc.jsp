...
<link href="bootstrap/css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
<title>Danh sách minh chứng</title>
<style>
body {
	padding-top: 10px;
}
...
<div id="wrapper">
	...
	<div class="panel panel-primary">
	  <div class="panel-heading">
	    <h3 class="panel-title"></h3><center>DANH SÁCH MINH CHỨNG</center></h3>
	  </div>
	  </div>
	...
	<tbody>
		<c:forEach items="${titfNew}" var="row">			
		<tr>	
		...
		<td>
			<button type="button" name="btnDelete" class="btn btn-default">
			<a href="Delete?id=${row.id }&rb=adminmc"><span class="glyphicon glyphicon-remove"></span></a>
			</button>
		</td>
