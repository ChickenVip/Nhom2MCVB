					...
					<nav aria-label="Page navigation">
					  <ul class="pagination">
					    <li>
							...
							<c:otherwise>
								<li> <a href="News?page=${selectPage - 1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
							</c:otherwise>
							</c:choose>		
					    ...
					    <li>
							...
							<c:otherwise>
								 <li><a href="News?page=${selectPage + 1}" aria-label="Previous"><span aria-hidden="true">&raquo;</span></a></li>
							</c:otherwise>
							</c:choose>				     
